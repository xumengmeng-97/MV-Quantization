...
#     def __init__(self, inp, oup, weight, stride, padding, groups=1, bias=False):
...
#
#         self.padding_info = [0, int(cols_odd), 0, int(rows_odd)]
#
#
#         return F.conv2d(self.inp, self.weight, self.stride, padding=(padding_rows // 2, padding_cols // 2), bias=self.bias, groups=self.groups)
class Conv2dTF(nn.Conv2d):
